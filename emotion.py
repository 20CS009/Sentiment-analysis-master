...
emo_dict = {}
emo_pol = {}
with open('D:\Sentiment_analysis-master\data/NRC-emotion-lexicon-wordlevel-alphabetized-v0.92.txt', 'r') as f:
...
rp = open('D:\Sentiment_analysis-master\data\pos_words.txt','r')
pos_list = [line.rstrip() for line in rp]

n_words_pos = len(pos_list)

rn = open('D:\Sentiment_analysis-master\data/neg_words.txt','r')
...
# Deal with test data
test_doc = open('D:/Sentiment_analysis-master/data/test_data.txt','r')
res_writer = open('D:\Sentiment_analysis-master/results\emotion_score_results.txt','w')
...
plt.savefig('D:\Sentiment_analysis-master/figs', dpi=400)
plt.show()
